...
/**
 * Created by wengangsai on 2016/11/08 0024.
 * 权利与荣耀
 */
@Controller
@RequestMapping("/activity/powerglory")
public class PowerGloryController extends BaseRestSpringController {

    private static String activityCode = "powerglory";

    private ActivityCountryService service = new ActivityCountryService();

    //Joyme网络 wxe6eafdebe1a95bd5 d878b4b82eb36fe487e909cf5886542e

    private static String APPID = "wxe6eafdebe1a95bd5";
    private static String SECRET = "d878b4b82eb36fe487e909cf5886542e";
...
//    private static String SECRET = "b58cd348c7f5908055e5e691eed45c39";
    ...
    //蓝点的key
    private static String BLUE_KEY = ActivityConstants.KEY_PREFIX + "powerglory_blue_";

    //国家的key
    private static String COUNTRY_KEY = ActivityConstants.KEY_PREFIX + "powerglory_country_";

    //个人的initpage
    private static String INITPAGE_KEY = ActivityConstants.KEY_PREFIX + "powerglory_initpage_";

    //测试的步数
    private static String TEST_KEY = ActivityConstants.KEY_PREFIX + "powerglory_test_";
    ...
    static {
        /*countryPointMap.put(5, "volibear");//雷熊
        countryPointMap.put(10, "frostwolf");//霜狼
        countryPointMap.put(15, "wingedlion");//飞狮
        countryPointMap.put(20, " horribull");//魔牛
        countryPointMap.put(25, "shadowsnake");//影蛇
        countryPointMap.put(36, "fighteagle");//战鹰*/
        ...
        bluePointList.add(19);

        bluePointList.add(21);
        bluePointList.add(23);
        bluePointList.add(25);
        bluePointList.add(27);
        bluePointList.add(28);
        bluePointList.add(30);
...
//        }
        ...
        return new ModelAndView("/jsp/powerGlory", mapMessage);
    }
    ...
    public String my(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            //
            String defaultVal = "寻得此处宝藏，即可获得CDK";
