...
@RequestMapping("/activity/qyzSecond")
@Controller
public class QyzSecondController extends BaseRestSpringController {
    ...
    public ModelAndView game(HttpServletRequest request,
        ...
        return new ModelAndView( "/jsp/qyz/gameSecond", mapMessage);
    }
