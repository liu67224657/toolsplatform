...
<body>
<div class="main">
    <div class="decrypt-2-l" style="opacity: 0;position: absolute;"></div>
    ...
    <div class="decrypt-2">
        <div class="d2-step-1 sy-1"></div>
        <div class="d2-step-1 sy-2"></div>
        <div class="d2-step-1 sy-3"></div>
        <div class="d2-step-1 sy-4"></div>
        <div class="d2-step-1 sy-5"></div>
        <div class="d2-step-2 sy-6"></div>

        <div class="d2-step-5 sy-7"></div>
        <img class="d2-step-6" src="http://static.joyme.com/mobile/qyz/images/jiemi-1-2.png">
        <img class="d2-step-3" src="http://static.joyme.com/mobile/qyz/images/jiemi-2-ts-1.png">
        <img class="d2-step-4" width="100%" height="100%" src="http://static.joyme.com/mobile/qyz/images/jiemi-2-bg-3.png">
        <div class="decrypt-2-window-bg"></div>
        <div class="decrypt-2-window">
        <img width="50" src="http://static.joyme.com/mobile/qyz/images/jiemi-2-ts-2.jpg">
    ...
    <div class="game-1">
        ...
        <div class="game-window game-1-show">
            ...
            <a href="/activity/qyzThird/game.do?code="+code><img class="game-tbn btn-next" width="30%" src="http://static.joyme.com/mobile/qyz/images/game-next-g.png"></a>
            ...
            <a href="/activity/qyzSecond/game.do?code="+code><img class="game-tbn btn-back" width="30%" src="http://static.joyme.com/mobile/qyz/images/btn-start.png"></a>
...
<script src="http://static.joyme.com/mobile/qyz/js/game2.js"></script>
