...
<head>
    ...
    <script src="http://static.joyme.beta/mobile/mgf/js/adaptive.js"></script>
    <script src="http://static.joyme.beta/mobile/mgf/libs/mobile-detect.min.js"></script>
    <script src="http://static.joyme.beta/mobile/mgf/libs/TweenMax.min.js"></script>
    <script src="http://static.joyme.beta/mobile/mgf/libs/easing/EasePack.min.js"></script>
    <script src="http://static.joyme.beta/mobile/mgf/libs/ScrollToPlugin.js"></script>
    <script src="http://static.joyme.beta/mobile/mgf/libs/easeljs-0.8.1.min.js"></script>
    <script src="http://static.joyme.beta/mobile/mgf/libs/tweenjs-0.6.1.min.js"></script>
    <script src="http://static.joyme.beta/mobile/mgf/libs/movieclip-0.8.1.min.js"></script>
    <script src="http://static.joyme.beta/mobile/mgf/libs/createjs-2015.11.26.min.js"></script>
    ...
    <style>
        * {
        ...
        .btn_close {
            ...
            width: 50px;
            height: 41px;
            background: url(http://static.joyme.beta/mobile/mgf/img/r8.png) no-repeat;
        ...
        .btn_submit {
            ...
            background: url(http://static.joyme.beta/mobile/mgf/img/btn_submit.jpg) no-repeat;
        ...
        .btn_sum_close {
            ...
            width: 0.57rem;
            height: 0.57rem;
            background: url(http://static.joyme.beta/mobile/mgf/img/close.jpg) no-repeat #00eaff center;
            border-radius: 100px;
...
<img src="http://static.joyme.beta/mobile/mgf/img/fx.png" width="50%"
     style="position: absolute; top: 0;left: 50% ;z-index: 11; display: none" id="fx">

<div id="loaderDIV" class="hideLoader">
    <img src="http://static.joyme.beta/mobile/mgf/img/loading.gif" class="loaderImg">
    <div class="loaderBox">
...
<section id="tip_human" class="tip_border">
    ...
    <img src="http://static.joyme.beta/mobile/mgf/img/r1.jpg" id="tip_main">
</section>
...
<section class="map">
    <a href="javascript:void(0)" class="btn_sum_close"></a>
    <div class="con1">
        <img src="http://static.joyme.beta/mobile/mgf/img/v1.jpg" id="map_pic">
...
<audio autoplay="autoplay">
    ...
    <source src="http://static.joyme.beta/mobile/mgf/sounds/WeAreElectric.mp3" type="audio/mpeg"/>

</audio>
</body>
<script src="http://static.joyme.beta/mobile/mgf/js/zepto.min.js"></script>
...
<script>
    ...
    function showMap(type) {
        $(".map").show(0);
        var isrc = "http://static.joyme.beta/mobile/mgf/img/v" + type + ".jpg";
        getEle("map_pic").src = isrc;
        showShade();
    }

    function showTipHuman(type) {
        getEle("tip_human").style.display = "block";
        var isrc = "http://static.joyme.beta/mobile/mgf/img/r" + type + ".jpg";
        getEle("tip_main").src = isrc;
    }
