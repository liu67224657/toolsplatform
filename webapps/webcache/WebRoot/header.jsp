...
<div id="joyme-head-2013">
    <div class="head-2013-box clearfix">
        ...
        <div class="head-2013-left">
            ...
            <span><a href="http://v.joyme.com/">着迷视频</a></span>
            <span><a href="http://wiki.joyme.com/">WIKI</a></span>
            <span><a href="${URL_WWW}/giftmarket" <c:if test="${hdflag=='giftmarket'}">class="on"</c:if> >礼包中心</a></span>
            <span><a href="http://bbs.joyme.com">论坛</a></span>
            <span><a href="http://html.joyme.com/mobile/gameguides.html">应用下载</a></span>
        </div>
