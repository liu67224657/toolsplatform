...
<!--header==end-->
<div id="cont-404" >
    <cite><img src="http://static.joyme.com/pc/cms/jmsy/images/500.png" alt="" /></cite>
...
<script>
    $(function(){
        ...
        (function(){
            var num = 5;
            var showtime = $("<p>服务器开小差了，页面将在<em>"+num+"</em>s之后跳转至<a id='jm-back' href='http://www.joyme.com'>首页</a><br />如果没有跳转，请点击下面的链接</p>");
