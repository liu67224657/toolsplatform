 ...
 */
@Controller
@RequestMapping("/batch/android/template")
public class BatchAndroidTemplateController {
    ...
    public ModelAndView page() {
        ...
        try {
            list = templateService.queryTemplate(null, AppPlatform.APP_PLATFORM_ANDROID);
        ...
        return new ModelAndView("/batch/android/page", map);
    }
    ...
    public ModelAndView uploadPage() {
        ...
        return new ModelAndView("/batch/android/uploadpage", mapMessage);
    }
    ...
    public ModelAndView upload(@RequestParam(value = "zip", required = false) MultipartFile srczip,
        ...
        try {
            AndroidTemplate androidTemplate = webService.uploadTemplate(srczip, code, version,AppPlatform.APP_PLATFORM_ANDROID);
        } catch (IOException e) {
            e.printStackTrace();
        } catch (JoymeDBException e) {
            e.printStackTrace();
        ...
        return new ModelAndView("redirect:/batch/android/template/page.do", mapMessage);
    }
}
