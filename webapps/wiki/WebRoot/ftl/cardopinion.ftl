    ...
    <div id="ab-1">
        ...
        <table class="formTable">
            ...
            <tr>
                ...
                <td class="t-3"><span style="display:none"  id="icon-error1"><i class="icon-error"></i>不能为空</span></td>
            </tr>
            <tr>
                <td class="t-1">姓名：</td>
                <td class="t-2"><span><input type="text" class="a_inputTxt" name="nickName" id="nickName" placeholder="真实姓名/昵称" /></span></td>
                <td class="t-3"><span style="display:none" id="icon-error2"><i class="icon-error"></i>不能为空</span></td>
            </tr>
            <tr>
                ...
                <td class="t-3"><span style="display:none" id="icon-error3"><i class="icon-error"></i>不能为空</span></td>
            </tr>
            </tbody>
        </table>
        <p id="sub"><a href="javascript:void(0)" onclick="saveq(1)" class="a_inputBtn" id="butt">提交</a></p>
    </div>
    <div id="ab-2">
        <div class="tips-box">
...
<table class="supTable">
    ...
    <tr>
        <td class="st-1">图片</td>
        <td class="sub-btn" style="position: relative;"><span class="sup-img"><img src="${cardImage}" alt="${cardName}" title="${cardName}" /></span>
            <span class="update-btn" onclick="_sqClick(-1)" style="position: absolute;right: 10px;bottom: 5px;"><font>修改</font></span>
        </td>
    </tr>
    <#if cardMap?exists>
        ...
        <tr>
            ...
            <td><b>${cardMap[key]}</b><#if cardMap[key]!=""><span class="update-btn"  onclick="_sqClick(${key_index})">修改</span></#if>
                <#if  cardMap[key]==""><span class="add-btn" onclick="_sqClick(${key_index})">添加</span></#if>
            </td>
        </tr>
        </#list>
    </#if>
