...
<body>
	<form name="form1" action="queryCondition.jsp?action=do" method="POST" onsubmit="return check()">
	...
	<%
	 ...
	 <!-- dao实现 -->
    <%
            GenerateQueryConditionDaoImpl cf=new GenerateQueryConditionDaoImpl();
	...
	&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	 ...
	 <!-- dao接口-->
    <%
            GenerateQueryConditionInterface inter = new GenerateQueryConditionInterface();
            inter.setDao(true);
	...
	<!-- service实现 -->
	<%
			GenerateQueryConditionService service = new GenerateQueryConditionService();
	...
	<!-- service dao -->
	<%
			GenerateQueryConditionInterface inter1 = new GenerateQueryConditionInterface();
		    inter1.setDao(false);
    ...
    String queryString =web.makeQueryConditionWeb(table, whereClause, true) ;
	%>
