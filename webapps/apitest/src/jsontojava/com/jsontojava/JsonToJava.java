...
import jsontojava.org.json.JSONArray;
import jsontojava.org.json.JSONException;
import jsontojava.org.json.JSONObject;
...
//		BufferedReader reader = new BufferedReader()
        ...
        try {
            ...
            if (mOutputOptions.contains(OutputOption.ONLYRESULT)) {
                try {
                    retVal = ((JSONObject) retVal).get("result");
                } catch (Exception ex) {
