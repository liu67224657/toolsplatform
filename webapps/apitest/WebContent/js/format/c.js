...
function ProcessObject(obj, indent, addComma, isArray, isPropertyContent){
  ...
  if(IsArray(obj)){
    if(obj.length == 0){
      ...
      clpsHtml = window.IsCollapsible ? "<span><img src='../../images/format/Collapsed.gif' onClick=\"ExpImgClicked(this)\" /></span><span class='collapsible'>" : "";
    ...
    if (obj == null){
      ...
      if(numProps == 0){
        ...
        clpsHtml = window.IsCollapsible ? "<span><img src='../../images/format/Expanded.gif' onClick=\"ExpImgClicked(this)\" /></span><span class='collapsible'>" : "";
