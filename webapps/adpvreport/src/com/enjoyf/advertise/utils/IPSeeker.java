...
//    private static final String IP_FILE = IPSeeker.class.getResource("/META-INF/qqwry.dat").toString().substring(5);
    ...
    private IPSeeker() {
        ...
        String IP_FILE = su.getMetaInfFolderPath() + "/qqwry.dat";
