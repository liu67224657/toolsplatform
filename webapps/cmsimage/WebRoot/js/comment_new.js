...
function getCommentList(cid, sort) {
    $.ajax({
                url : "http://www.joyme.test/jsonp/api/comment/commentlist",
                type : "post",
                async:false,
...
function getHotCommentList(contentid) {
    $.ajax({
                url : "http://www.joyme.test/jsonp/api/comment/hotlist",
                type : "post",
                async:false,
                data:{cid:contentid},
                dataType : "jsonp",
...
function postreComment(rid, pid, body, reCommentDom) {
    ...
    $.ajax({
                url : "http://www.joyme.test/jsonp/api/comment/post",
                type : "post",
                async:false,
...
function agreeComment(rid) {
    ...
    $.ajax({
                url : "http://www.joyme.test/jsonp/api/comment/agree",
                type : "post",
                async:false,
                data:{rid:rid},
                dataType : "jsonp",
