...
<%
    ...
    if (messgae == null || encrypt == null || StringUtil.isEmpty(messgae) || StringUtil.isEmpty(encrypt)) {
        href = PropertiesContainer.getToolsLoginURL();
    }
        ...
        if (messgae != null) {
            ...
            if (encrypt.equals(marticleEncrypt)) {
                ...
                if (roidSet.contains(1) || roidSet.contains(104)) {
                    href = PropertiesContainer.getCmsimageMainJsp();
                } else {
                    href = null;
                }
            } else {
...
<script>
    ...
    if(href=="null"){
        ...
        document.getElementById("login").href="<%=PropertiesContainer.getToolsLoginURL()%>";
    }
</script>
</body>
</html>
