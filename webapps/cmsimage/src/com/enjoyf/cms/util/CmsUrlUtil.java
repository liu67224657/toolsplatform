...
import com.enjoyf.cms.factory.DefaultHtmlPraser;
import com.enjoyf.cms.factory.IHtmlPraser;
import com.enjoyf.cms.factory.MHtmlPraser;
...
public class CmsUrlUtil {
    ...
    public static int checkDomain(URL url) throws MalformedURLException {
        ...
        String envDomain = PropertiesContainer.getEnvDomain();
