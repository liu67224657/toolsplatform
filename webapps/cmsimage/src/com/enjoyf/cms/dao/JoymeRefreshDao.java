...
public class JoymeRefreshDao extends BaseJDBCDAOImpl {
     ...
     * @return JoymeRefresh
     */
    public JoymeRefresh queryJoymeRefreshbyId(ConnectionBean conn, Integer freshId) throws JoymeDBException {
        DataBean dbean = null;
        try {
     ...
     */
    public int queryMaxJoymeRefreshId(ConnectionBean conn) throws JoymeDBException {
        DataBean dbean = null;
        try {
     ...
     * @throws JoymeDBException
     */
    public List queryJoymeRefreshItem(ConnectionBean conn , int maxFreshId) throws JoymeDBException {
        DataBean dbean = null;
        try {
            String sql = "SELECT * FROM joyme_refresh WHERE fresh_id > ?";
            List objectList = new ArrayList();
     ...
     */
    public int insertJoymeRefresh(ConnectionBean conn, JoymeRefresh bean) throws JoymeDBException {
        try {
     ...
     * @return int 1 success, 0 failed
     */
    public int updateJoymeRefresh(ConnectionBean conn, JoymeRefresh bean) throws JoymeDBException {
        try {
     ...
     * @return int 1 success, 0 failed
     */
    public int deleteJoymeRefresh(ConnectionBean conn, Integer freshId) throws JoymeDBException {
        try {
