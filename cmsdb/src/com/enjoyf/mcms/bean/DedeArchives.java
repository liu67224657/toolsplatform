...
public class DedeArchives implements Serializable {
    ...
    //文章详细页 相关新闻
    private List<DedeAddonrelevance> relatedNewsList;

    private Integer showios;
    private Integer showandroid;
    ...
    public List<DedeAddonrelevance> getRelatedNewsList() {
        return relatedNewsList;
    }

    public void setRelatedNewsList(List<DedeAddonrelevance> relatedNewsList) {
    ...
    public Integer getShowios() {
        return showios;
    }

    public void setShowios(Integer showios) {
        this.showios = showios;
    }

    public Integer getShowandroid() {
        return showandroid;
    }

    public void setShowandroid(Integer showandroid) {
    ...
    public List getNotNullColumnList() {
        ...
        if (clientnote != null) {
            NotNullColumnBean bean = new NotNullColumnBean();
            bean.setColumnName("clientnote");
            bean.setObj(clientnote);
            columnList.add(bean);
        }
        if (categoryid != null) {
            NotNullColumnBean bean = new NotNullColumnBean();
        ...
        if (relatedNewsList != null) {
            NotNullColumnBean bean = new NotNullColumnBean();
            bean.setColumnName("relatedNewsList");
            bean.setObj(relatedNewsList);
            columnList.add(bean);
        }
        if (showios != null) {
            NotNullColumnBean bean = new NotNullColumnBean();
            bean.setColumnName("showios");
            bean.setObj(showios);
            columnList.add(bean);
        }
        if (showandroid != null) {
            NotNullColumnBean bean = new NotNullColumnBean();
            bean.setColumnName("showandroid");
            bean.setObj(showandroid);
            columnList.add(bean);
        }
