...
public class DedeArchivesService {
	...
	public Object[] getArchivesPointList(Connection conn, String filename) throws JoymeDBException, JoymeServiceException {
		...
		if (archive == null) {
			LogService.warnSystemLog("Find archiveList is null which filename is : " + filename);
			return null;
		}
	...
	public DedeArchivePageBean queryDedeArchiveListByTypeId(Connection conn, int typeid, int pageNum) throws Exception {
		boolean isCloseConn = (conn != null) ? false : true;
		try {
			if (conn == null)
				conn = subDao.getConnection();
			return subDao.queryDedeArchiveListByTypeId(conn, typeid, pageNum);
		} catch (JoymeDBException e) {
			throw e;
		} catch (Exception e) {
			throw new JoymeServiceException(e);
	...
	public DedeArchivePageBean queryDedeArchiveListByCategoryId(Connection conn, int platform, int categoryId, List objectList, int pageNum, int pageCount) throws Exception {
		boolean isCloseConn = (conn != null) ? false : true;
		try {
			if (conn == null)
				conn = subDao.getConnection();
			return subDao.queryDedeArchiveListByCategoryId(conn, platform, categoryId,objectList, pageNum, pageCount);
		} catch (JoymeDBException e) {
			throw e;
		} catch (Exception e) {
			throw new JoymeServiceException(e);
	 ...
	 * @throws JoymeServiceException
	 */
	public List queryTagArchives(Connection conn, List tagNameList, List typeIdList, int maxId, int pageNum) throws JoymeDBException, JoymeServiceException {
		boolean isCloseConn = (conn != null) ? false : true;
		try {
			if (conn == null)
				conn = subDao.getConnection();
			return subDao.queryTagArchives(conn, tagNameList, typeIdList, maxId, pageNum);
		} catch (JoymeDBException e) {
			throw e;
		} catch (Exception e) {
			throw new JoymeServiceException(e);
	...
	public int updateDedearchivesPubdate(Connection conn, DedeArchives dedeArchives) throws JoymeDBException, JoymeServiceException {
		boolean isCloseConn = (conn != null) ? false : true;
		try {
			if (conn == null)
				conn = subDao.getConnection();
			return subDao.updateDedearchivesPubdate(conn, dedeArchives);
		} catch (JoymeDBException e) {
			throw e;
		} catch (Exception e) {
			throw new JoymeServiceException(e);
